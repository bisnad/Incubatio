...
class ofApp : public ofBaseApp
{
	...
	protected:
		...
		// or for simply forwarding Mocap Data from MVN Analyze Pro
		std::shared_ptr<dab::Data> mXSensJointRotEulerData;
		std::shared_ptr<dab::Data> mXSensJointLinVelData;
		std::shared_ptr<dab::Data> mXSensJointAngVelData;
		std::shared_ptr<dab::Data> mXSensJointLinAccelData;
		std::shared_ptr<dab::Data> mXSensJointAngAccelData;

		std::shared_ptr<dab::DataProcInput> mXSensJointRotEulerProc;
		std::shared_ptr<dab::DataProcInput> mXSensJointLinVelInputProc;
		std::shared_ptr<dab::DataProcInput> mXSensJointAngVelInputProc;
		std::shared_ptr<dab::DataProcInput> mXSensJointLinAccelInputProc;
		std::shared_ptr<dab::DataProcInput> mXSensJointAngAccelInputProc;

		std::shared_ptr<dab::DataProcLowPass> mXSensJointLinAccelSmoothProc;
		std::shared_ptr<dab::DataProcDerivative> mXSensJointLinJerkProc;
		std::shared_ptr<dab::DataProcLowPass> mXSensJointLinJerkSmoothProc;
		std::shared_ptr<dab::DataProcScalar> mXSensJointLinJerkScalarProc;

		std::shared_ptr<dab::DataProcLowPass> mXSensJointAngAccelSmoothProc;
		std::shared_ptr<dab::DataProcDerivative> mXSensJointAngJerkProc;
		std::shared_ptr<dab::DataProcLowPass> mXSensJointAngJerkSmoothProc;
		std::shared_ptr<dab::DataProcScalar> mXSensJointAngJerkScalarProc;
