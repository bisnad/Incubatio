...
const float StreamManager::sSegmentPositionXOffset = 100.0;
...
StreamManager::updatePoseDataEuler(unsigned char* pDatagram) throw (dab::Exception)
{
	...
	try
	{
		MocapSkeletonManager::get().updateProperty(character_id, "/mocap/joint/pos_world", segmentPositions);
		MocapSkeletonManager::get().updateProperty(character_id, "/mocap/joint/rot_world_euler", segmentRotationsEuler);
	}
	catch (dab::Exception& e)
	{
...
StreamManager::updatePoseDataQuaternion(unsigned char* pDatagram) throw (dab::Exception)
{
	...
	if (sBigEndian == true)
	{
		for (int mI = sDatagramHeaderSize, sI = 0; sI < sSegmentCount; mI += sDatagramPoseDataQuaternionSizePerSegment, sI += 1)
		{
			...
			//segmentPositions[sI * 3] = segment_position_x;
			segmentPositions[sI * 3] = segment_position_x + sSegmentPositionXOffset;
			segmentPositions[sI * 3 + 1] = segment_position_y;
			segmentPositions[sI * 3 + 2] = segment_position_z;
	...
	{
		MocapSkeletonManager::get().updateProperty(character_id, "/mocap/joint/pos_world", segmentPositions);
		MocapSkeletonManager::get().updateProperty(character_id, "/mocap/joint/rot_world", segmentRotationsQuat);
	}
	catch (dab::Exception& e)
	{
		e += dab::Exception("Network Error: failed to update pose data euler\n", __FILE__, __FUNCTION__, __LINE__);
...
StreamManager::updateLinearSegmentKinematics(unsigned char* pDatagram) throw (dab::Exception)
{
	...
	{
		MocapSkeletonManager::get().updateProperty(character_id, "/mocap/joint/pos_world", segmentPositions);
		MocapSkeletonManager::get().updateProperty(character_id, "/mocap/joint/lin_vel", segmentVelocities);
		MocapSkeletonManager::get().updateProperty(character_id, "/mocap/joint/lin_acc", segmentAccelerations);
	}
	catch (dab::Exception& e)
	{
...
StreamManager::updateAngularSegmentKinematics(unsigned char* pDatagram) throw (dab::Exception)
{
	...
	{
		MocapSkeletonManager::get().updateProperty(character_id, "/mocap/joint/rot_world", segmentRotationsQuat);
		MocapSkeletonManager::get().updateProperty(character_id, "/mocap/joint/rot_vel", segmentVelocities);
		MocapSkeletonManager::get().updateProperty(character_id, "/mocap/joint/rot_acc", segmentAccelerations);
	}
	catch (dab::Exception& e)
	{
...
StreamManager::updateMotionTrackerKinematics(unsigned char* pDatagram) throw (dab::Exception)
{
	...
	try
	{
		MocapSkeletonManager::get().updateProperty(character_id, "/mocap/tracker/id", trackerIds);
		MocapSkeletonManager::get().updateProperty(character_id, "/mocap/tracker/rot_world", trackerRotationsQuat);
		MocapSkeletonManager::get().updateProperty(character_id, "/mocap/tracker/accel_world", trackerGlobalAccelerations);
		//MocapSkeletonManager::get().updateProperty(character_id, "/mocap/tracker/accel", trackerAccelerations);
		//MocapSkeletonManager::get().updateProperty(character_id, "/mocap/tracker/angular_vel", trackerAngularVelocities);
		MocapSkeletonManager::get().updateProperty(character_id, "/mocap/tracker/magnet", trackerMagneticFields);
	}
	catch (dab::Exception& e)
	{
		e += dab::Exception("Network Error: failed to update angular segment kinematics\n", __FILE__, __FUNCTION__, __LINE__);
...
StreamManager::updateJointAngles(unsigned char* pDatagram) throw (dab::Exception)
{
	...
	try
	{
		MocapSkeletonManager::get().updateProperty(character_id, "/mocap/joint/angles", jointAngles);
	}
	catch (dab::Exception& e)
	{
		e += dab::Exception("Network Error: failed to update angular segment kinematics\n", __FILE__, __FUNCTION__, __LINE__);
