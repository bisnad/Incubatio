/** \file dab_flock_ring_behavior.h
 *  \class dan::flock::RingBehavior cause Agent to move withing a ring
...
#ifndef _dab_flock_ring_behavior_h_
#define _dab_flock_ring_behavior_h_
...
namespace dab
{
	...
	namespace flock
	{
		...
		class RingBehavior : public Behavior
		{
		public:
			/**
			 ...
			 */
			RingBehavior(const std::string& pInputParameterString, const std::string& pOutputParameterString);
			 ...
			 */
			RingBehavior(Agent* pAgent, const std::string& pBehaviorName, const std::string& pInputParameterString, const std::string& pOutputParameterString) throw (Exception);
		...
		protected:
			...
			Parameter* mRadialAmountPar; /// \brief radial amount parameter (internal)
